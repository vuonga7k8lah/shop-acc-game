...
<head>
    ...
    <link href="{{asset("css/socicon.css")}}" rel="stylesheet" type="text/css"/>
    <link href="{{asset("css/bootstrap-social.css")}}" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset("css/socicon.css")}}css/font-awesome.min.css" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset("css/socicon.css")}}css/simple-line-icons.min.css" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset("css/socicon.css")}}css/animate.min.css" rel="stylesheet" type="text/css"/>
    ...
    <link href="{{asset("css/components.css")}}" id="style_components" rel="stylesheet"
          type="text/css"/>
    <link href="{{asset("css/default.css")}}" rel="stylesheet" id="style_theme"
          type="text/css"/>
                ...
                <nav class="menu-main-mobile c-mega-menu c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold hidden-md hidden-lg">
                    <ul  class="nav navbar-nav c-theme-nav">
                        ...
                        <li class="c-menu-type-classic">
                            <a  rel=""  href="#" class="c-link dropdown-toggle ">Tin tức<span class="c-arrow c-toggler"></span></a>
                            <ul id="children-of-42" class="dropdown-menu c-menu-type-classic c-pull-left " >
                                <li class="c-menu-type-classic"><a  rel="" href="{{route('blog')}}"
                                                                    class="">Blog</a></li>
                                <li class="c-menu-type-classic"><a  rel="" href="/uy-tin-cua-shop" class="">UY T&Iacute;N CỦA SHOP</a></li>
                                <li class="c-menu-type-classic"><a  rel="" href="/danh-sach-gdv-group" class="">Danh S&aacute;ch GDV group</a></li>
                                <li class="c-menu-type-classic"><a  rel="" href="/dich-vu-game" class="">Dịch Vụ Game</a></li>
...
<script src="{{asset('js/reveal-animate.js')}}"
...
<script src="{{asset('js/jquery.smooth-scroll.js')}}"
        type="text/javascript"></script>
...
<script src="{{asset('js/datepicker.js')}}"
        type="text/javascript"></script>
<script src="{{asset('js/jquery.mask.min.js')}}"
        type="text/javascript"></script>
